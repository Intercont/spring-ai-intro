package com.igorfragadev.springaiintro.prompengineering;
...
/**
 * Created by jt, Spring Framework Guru, refactored by Igor Fraga
 */
@SpringBootTest
public class ZeroAndFewShotTests extends BaseTestClass {
    ...
    void zeroShotPromptTest() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            Prompt prompt = promptTemplate.create(Map.of("review", UUID.randomUUID() + "\n" + review));
...
//                .model("gpt-4-turbo-preview") //actual is newer than the used in the tests on the course
                .build();
